...
export type ModuleId = 'dashboard' | 'planes' | 'evaluaciones' | 'radar' | 'formacion' | 'prorrogas' | 'reportes' | 'admin'
...
export const moduleDescriptions: Record<ModuleId, string> = {
  ...
  formacion: 'Solicitudes de formacion a For+ vinculadas a planes.',
...
export const roleModuleAccess: Record<RoleType, ModuleId[]> = {
  gh: ['dashboard', 'planes', 'evaluaciones', 'radar', 'formacion', 'prorrogas', 'reportes', 'admin'],
  ...
  forplus: ['dashboard', 'planes', 'formacion'],
  relaciones: ['dashboard', 'planes', 'prorrogas', 'reportes'],
  admin_gestion: ['dashboard', 'planes', 'evaluaciones', 'prorrogas', 'reportes'],
  admin_tecnico: ['dashboard', 'planes', 'evaluaciones', 'radar', 'formacion', 'prorrogas', 'reportes', 'admin'],
}
