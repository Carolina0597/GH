...
export type ModuleId = 'dashboard' | 'planes' | 'evaluaciones' | 'radar' | 'reportes' | 'admin'
...
export const roleModuleAccess: Record<RoleType, ModuleId[]> = {
  gh: ['dashboard', 'planes', 'evaluaciones', 'radar', 'reportes', 'admin'],
  peopleops: ['dashboard', 'planes', 'evaluaciones', 'radar', 'reportes'],
  ...
  admin_tecnico: ['dashboard', 'planes', 'evaluaciones', 'radar', 'reportes', 'admin'],
}
